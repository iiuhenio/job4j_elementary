...
public class AlgoArray {
    public static void main(String[] args) {
        ...
        int temp1 = array[1]; /* переменная для временного хранения значение ячейки с индексом 1. */
        array[1] = array[2]; /* записываем в ячейку с индексом 1 значение ячейки с индексом 2. */
        array[2] = temp1; /* записываем в ячейку с индексом 2 значение временной переменной. */
        int temp2 = array[3];
        array[3] = array[4];
        array[4] = temp2;
